...
class PrototypicalCalibrationBlock:
    ...
    def __init__(self, cfg, proto_dataset=None):
        super().__init__()
        self.cfg = cfg
    ...
    def build_prototypes(self):
        ...
        for index in range(len(self.proto_dataset)):
            inputs = [self.proto_dataset[index]]
            assert len(inputs) == 1
